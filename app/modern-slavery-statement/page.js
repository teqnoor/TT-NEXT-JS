  ...
  return (
    <>
      <section className="py-12">
        ...
        >
          <h4 className="eczar mb-3">HYPERAMA GROUP MODERN SLAVERY STATEMENT</h4>
          <p className="mb-3">
          ...
          <h4 className="eczar mb-3">INTRODUCTION FROM THE BOARD OF DIRECTORS</h4>
          <p className="mb-3">
          ...
          <h4 className="eczar mb-3">OUR COMPANY</h4>
          <p className="mb-3">
          ...
          <h4 className="eczar mb-3">SUPPLY CHAIN</h4>
          <p className="mb-3">
          ...
          <h4 className="eczar mb-3">STANDARDS IN OUR BUSINESS</h4>
          <p className="mb-3">
          ...
          <h4 className="eczar mb-3">EMPLOYMENT</h4>
          <p className="mb-3">
          ...
          <h4 className="eczar mb-3">POLICIES/PROCEDURES</h4>
          <p className="mb-3">
          ...
          <h4 className="eczar mb-3">ENDORSEMENT OF THIS STATEMENT</h4>
          <p className="mb-3">
